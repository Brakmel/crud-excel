...
<body>
    <header>
      ...
      <main>
        <h1 class="h1">
            Bienvenido al sistema de Reserva de Salas USM
        </h1>
        <p class="p">¿Que desea hacer?</p>
        <a href="CRUD/Php/Administrador.php"><input type="button" value="Deseo administrar las reservas de Salas"></a>
        <a href="importar/index.php"><input type="button" value="Deseo importar un Excel"></a>
      </main>
      <footer>
